...
if lightline#colorscheme#background() ==# 'dark'
    ...
    let s:shade1 = s:gray7
    let s:shade2 = s:gray5
    let s:shade3 = s:gray6
    let s:shade4 = s:gray5
    let s:shade5 = s:gray7
endif
...
let s:p.normal.left    = [[s:fg, s:shade1, 'bold'], [s:fg, s:shade2]]
let s:p.normal.middle  = [[s:fg, s:shade3]]
let s:p.normal.right   = [[s:fg, s:shade5, 'bold'], [s:fg, s:shade4]]
let s:p.normal.error   = [[s:red2, s:fg, 'bold']]
let s:p.normal.warning = [[s:gold, s:fg]]

let s:p.insert.left    = [[s:fg, s:green, 'bold'], [s:fg, s:shade4]]
let s:p.replace.left    = [[s:fg, s:red2, 'bold'], [s:fg, s:shade4]]
let s:p.visual.left    = [[s:fg, s:purple, 'bold'], [s:fg, s:shade4]]

let s:p.tabline.left   = [[s:fg, s:shade4]]
